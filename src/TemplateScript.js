...
function fixObsoleteTemplatesOnPtwiki( context ){
	...
	oldText = context.$target.val();
	list = [{
		find: /<!--+ *(?:Inserir categorias e interwikis apenas na página de DOC desta predefinição|(?:Please )?Add categories (?:and interwikis )?to the \/doc (?:sub)?page, (?:not here(?:!|, thanks)|thanks)) *--+>/gi,
